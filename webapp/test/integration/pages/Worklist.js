sap.ui.define([
		...
		"com/bmc/hcm/erf/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
						...
						return this.waitFor(createWaitForItemAtPosition({
							...
							success : function (oTableItem) {
								...
								this.getContext().currentItem = {
									...
									id: oBindingContext.getProperty("Erfid"),
									name: oBindingContext.getProperty("ErfjdTr")
								};
							}
						}));
					},
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all EmployeeRequestFormSet to be able to check for the total amount
